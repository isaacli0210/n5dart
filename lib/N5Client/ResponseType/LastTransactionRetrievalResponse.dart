...
class LastTransactionRetrievalResponse extends IResponseBody {
  ...
  @override
  ResponseEvent EVENT_NAME = ResponseEvent.RETRIEVAL_RESP;
  String TXN_TYPE;
  String TXN_ID;
  String STATUS;
  String TXN_STATUS;
  ...
  LastTransactionRetrievalResponse(String jsonString) {
    RAW_JSON = jsonString;
